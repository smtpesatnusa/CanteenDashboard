...
{
    public partial class FormMainNineOut : MaterialForm
    {
        ...
        public void absent()
        {
            try
            {
                ...
                else if (roomtb.Text == "SMT-MAINOUT")
                {
                    queryAbsent =
                    "SELECT b.linecode, c.description AS section, b.badgeID, b.name,  MAX(a.timelog)AS timelog FROM tbl_log a, tbl_employee b, tbl_masterlinecode c " +
                    "WHERE a.rfidno = b.rfidno AND b.linecode = c.name AND(a.ipDevice = 'SMT-MAINOUT')GROUP BY b.badgeID, b.name, b.linecode ORDER BY timelog DESC LIMIT 9";
                }
